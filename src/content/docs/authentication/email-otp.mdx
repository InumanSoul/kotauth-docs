...

{
  ...
  "resources": ["https://api.yourdomain.com"]
}
```
...
| `resources` | No | Array of [RFC 8707](https://www.rfc-editor.org/rfc/rfc8707) resource indicator URIs. When provided, the resulting authorization code is bound to these resources. Defaults to an empty list. |
